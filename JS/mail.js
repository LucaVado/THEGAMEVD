...
let isRankRefDisplayed = false;
let isRankRefDisplayed1 = false;

window.addEventListener('load', toggleTables);
// Función para cambiar entre tablas
function toggleTables() {
    isRankRefDisplayed = !isRankRefDisplayed; // Cambia el estado de la variable
    isRankRefDisplayed1 = !isRankRefDisplayed1; // Cambia el estado de la variable
    // Cambiar el título
    const titulo = document.getElementById('tituloTabla');
    const titulo1 = document.getElementById('tituloTabla1');
    titulo.innerHTML = isRankRefDisplayed ? 'Mejores puntuaciones' : 'Mejores puntuaciones extremos!';
    titulo1.innerHTML = isRankRefDisplayed1 ? 'Mejores puntuaciones' : 'Mejores puntuaciones extremos!';
